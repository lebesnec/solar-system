...
class SceneComponent {
    ...
    initCelestialBodies() {
        this.groupZoomableSelection.selectAll('.celestial-body')
            ...
            .attr('r', (body) => body.radius / _scene_service__WEBPACK_IMPORTED_MODULE_5__["KM_TO_PX"])
