    ...
    initLabels() {
        ...
        const labels = this.groupStaticSelection.selectAll('.label')
            ...
            this.labelsPath.attr('d', `M ${d.boundingBox.x + (d.boundingBox.width / 2)} ${d.boundingBox.y + (d.boundingBox.height / 2)}
                ...
                .style('opacity', 1);
            Object(d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"])('#orbit_' + d.body.id).classed('over', true);
        })
            .on('mouseout', (event, d) => {
            this.labelsPath.transition()
                .duration(LABEL_TRANSITION_MS)
                .style('opacity', 0);
            Object(d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"])('#orbit_' + d.body.id).classed('over', false);
        })
            .on('mousedown', () => {
            this.labelsPath.style('opacity', 0);
        })
