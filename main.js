...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! d3 */ "iYt/");
/* harmony import */ var _shell_search_panel_search_panel_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../shell/search-panel/search-panel.service */ "2CAJ");
...
class SceneComponent {
    ...
    ngAfterViewInit() {
        this.svgSelection = Object(d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"])('svg').on('click', () => {
            Object(d3__WEBPACK_IMPORTED_MODULE_15__["selectAll"])('.selected').classed('selected', false);
        });
    ...
    initLabels() {
        ...
        const labels = this.groupStaticSelection.selectAll('.label')
            ...
            this.labelsPath.attr('d', `M ${d.boundingBox.x + (d.boundingBox.width / 2)} ${d.boundingBox.y + (d.boundingBox.height / 2)}
                ...
                .style('opacity', 1);
            Object(d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"])('#orbit_' + d.body.id).classed('hovered', true);
        })
            .on('mouseout', (event, d) => {
            this.labelsPath.transition()
                .duration(LABEL_TRANSITION_MS)
                .style('opacity', 0);
            Object(d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"])('#orbit_' + d.body.id).classed('hovered', false);
        })
            .on('mousedown', () => {
            this.labelsPath.style('opacity', 0);
        })
            ...
            this.zoomTo(d.body);
            Object(d3__WEBPACK_IMPORTED_MODULE_15__["selectAll"])('.selected').classed('selected', false);
            Object(d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"])('#labeltext_' + d.body.id).classed('selected', true);
            Object(d3_selection__WEBPACK_IMPORTED_MODULE_2__["select"])('#orbit_' + d.body.id).classed('selected', true);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SceneComponent, [{
    ...
    }], function () { return [{ type: _scene_service__WEBPACK_IMPORTED_MODULE_5__["SceneService"] }, { type: _shell_search_panel_search_panel_service__WEBPACK_IMPORTED_MODULE_16__["SearchPanelService"] }]; }, null); })();
